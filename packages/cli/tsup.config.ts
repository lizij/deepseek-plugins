...
const bannerJs = [
  ...
  '":" //# ;   printf \'❌ 未检测到 Node.js。deepseek-plugin-cli 需要 Node.js 20+，请安装：https://nodejs.org\\n\' >&2',
  '":" //# ;   exit 127',
  '":" //# ; fi',
  '":" //# ; _dsp_node_major=$(node -p "parseInt(process.versions.node.split(\'.\')[0])")',
  '":" //# ; if [ "$_dsp_node_major" -lt 20 ]; then',
  '":" //# ;   printf "❌ Node.js 版本过低（当前 v%s），需要 20+，请升级后重试\\n" "$(node -v)" >&2',
  '":" //# ;   exit 1',
  '":" //# ; fi',
